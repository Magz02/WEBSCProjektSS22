...
<body>
    <?php
        if(isset($_POST['create'])) {
            ...
            if (!$statement->bind_param("ssss", $creatorName,$location, $appointName, $description)){
    ...
    <div>
        <form action="newAppointment.php" method="post">
            <div class="container" style="background-color: light;">
                ...
                <input type="text" id="location" name="location" placeholder="Location" required minlength="3"></br>
